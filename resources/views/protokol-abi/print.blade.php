...
<head>
    ...
    <title>Pemeriksaan ABI {{ $protokol->no_protokol }}</title>
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        .table-interpretasi th,
        .table-interpretasi td {
        ...
        .table-interpretasi th:nth-child(1),
        .table-interpretasi td:nth-child(1) {
            width: 25%;
        }

        .table-interpretasi th:nth-child(2),
        .table-interpretasi td:nth-child(2) {
            width: 75%;
        }
...
<body>
    <div class="page-wrapper">
        <div class="toolbar">
            <span>&#128196; Pemeriksaan ABI {{ $protokol->no_protokol }} &mdash; {{ $protokol->nama_pasien }}</span>
        ...
        <div class="abi-paper">
            ...
            <div class="rumus-section">
                ...
                <div class="rumus-calc">
                    Highest Systolic Brachial Pressure : <strong>{{ $protokol->highest_brachial_sistolik }}
                        mmHg</strong>
                </div>
                <div class="rumus-calc">
                    ABI<sub>left</sub> = {{ $protokol->abi_left_pembilang }} mmHg / {{ $protokol->abi_left_penyebut }}
                    mmHg
                    = <strong>{{ number_format($protokol->abi_left_hasil, 2) }}</strong>
                </div>
                <div class="rumus-calc">
                    ABI<sub>right</sub> = {{ $protokol->abi_right_pembilang }} mmHg /
                    {{ $protokol->abi_right_penyebut }} mmHg
            ...
            <table class="table-interpretasi">
                ...
                <tbody>
                    ...
                    <tr>
                        <td>0.41 - 0.90</td>
                        <td>Mild-to-moderate peripheral arterial disease</td>
                    </tr>
                    <tr>
                        <td>0.00 - 0.40</td>
                        <td>Severe peripheral arterial disease</td>
                    </tr>
                </tbody>
            </table>
                ...
                <tr>
                    ...
                    <td style="text-align:center; vertical-align:top; font-size:8pt;">
                        ...
                        <div style="border-top:1pt solid #111; padding-top:3pt; font-size:8.5pt; font-weight:bold;">
                            {{ Auth::user()->isDokter() ? 'dr. ' : '' }}{{ $protokol->nama_dokter }}
                        </div>
                    </td>
                </tr>
            </table>
